...
with st.container():
    ...
    base_choice = st.selectbox(
        ...
        index=0,
        help="Escolha uma base que realce vegetação/lavoura. 'Esri Satélite' ou 'Sentinel-2 Cloudless' costumam mostrar vegetação com mais contraste."
    )
    ...
    try:
        ...
        # Centro padrão (baseado no BBOX de exemplo)
        ...
        # --- Camadas base (apenas UMA visível por vez) ---
        # Esri Satellite
        folium.TileLayer(
        ...
        # Sentinel-2 Cloudless (EOX 2020) - mosaico livre com alta visibilidade de vegetação
        folium.TileLayer(
        ...
        # Render (sem argumentos extras para máxima compatibilidade)
        map_state = st_folium(m, height=520, key="map_aoi")

        # Extrai BBOX a partir dos desenhos
